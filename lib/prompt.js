...
## SCORING SCALE
Score each of the 16 behaviours on a 1–4 scale:
- 1 (Weak): Almost absent. Predominantly negative indicators, or positive indicators nearly invisible.
- 2 (Developing): Present but inconsistent. Some positive indicators outweighed by gaps or negatives.
- 3 (Effective): Mostly positive. Clear positive indicators with only minor gaps or lapses.
- 4 (Exemplary): Strongly and consistently present. Multiple clear positive indicators, negligible negatives.
...

{
  ...
  "portIn": {
    "purpose":          { "score": <1-4>, "evidence": "<specific evidence from transcript, 1–2 sentences>" },
    "outcomes":         { "score": <1-4>, "evidence": "<specific evidence from transcript, 1–2 sentences>" },
    "responsibilities": { "score": <1-4>, "evidence": "<specific evidence from transcript, 1–2 sentences>" },
    "timedAgenda":      { "score": <1-4>, "evidence": "<specific evidence from transcript, 1–2 sentences>" }
  },
  "safe": {
    "share":    { "score": <1-4>, "evidence": "<specific evidence from transcript, 1–2 sentences>" },
    "ask":      { "score": <1-4>, "evidence": "<specific evidence from transcript, 1–2 sentences>" },
    "facilitate": { "score": <1-4>, "evidence": "<specific evidence from transcript, 1–2 sentences>" },
    "energise": { "score": <1-4>, "evidence": "<specific evidence from transcript, 1–2 sentences>" }
  },
  "race": {
    "resolve":   { "score": <1-4>, "evidence": "<specific evidence from transcript, 1–2 sentences>" },
    "actioning": { "score": <1-4>, "evidence": "<specific evidence from transcript, 1–2 sentences>" },
    "challenge": { "score": <1-4>, "evidence": "<specific evidence from transcript, 1–2 sentences>" },
    "economise": { "score": <1-4>, "evidence": "<specific evidence from transcript, 1–2 sentences>" }
  },
  "portOut": {
    "plan":             { "score": <1-4>, "evidence": "<specific evidence from transcript, 1–2 sentences>" },
    "outcomes":         { "score": <1-4>, "evidence": "<specific evidence from transcript, 1–2 sentences>" },
    "responsibilities": { "score": <1-4>, "evidence": "<specific evidence from transcript, 1–2 sentences>" },
    "time":             { "score": <1-4>, "evidence": "<specific evidence from transcript, 1–2 sentences>" }
  },
  "redFlags": [
    "<red flag description — specific and grounded in the transcript>"
  ],
  "recommendations": [
    "<concrete, actionable recommendation using Polaris language>",
    "<concrete, actionable recommendation using Polaris language>",
    "<concrete, actionable recommendation using Polaris language>"
  ]
}`;
