...
// Polaris Formula scoring prompt — updated to George Karseras brief 040626
...
- Decision Making Quality (RACE): Resolve 20%, Actioning 20%, Challenge 30%, Economise 30%
- Gaining Clarity: A of SAFE 25%, F of SAFE 25%, C of RACE 25%, Clarity of Delivery 25%
- Overall: Effective Start 20%, Psychological Safety 20%, Decision Making Quality 20%, Clarity 10%, Effective Close 30%
` : `
...
- Decision Making Quality (RACE): Resolve 35%, Actioning 15%, Challenge 35%, Economise 15%
...
Negative (-5 points each): blaming questions ('why did you do this?'); questions used to prove a point; closed, rhetorical, or leading questions.
...
## EVIDENCE
One sentence per behaviour — maximum 30 words. Cite a specific moment or phrase. For scores below 2.5, name the dismissal pattern or absent behaviour explicitly. No preamble, no hedging.
...
- MAP_mirror | MAP | "Mirror": reflecting on how the group is working
- MAP_adjust | MAP | "Adjust": changing approach mid-meeting
- MAP_progress | MAP | "Progress": acknowledging momentum toward a goal
...
- OPINION | General | "Opinion/Statement": general statements not mapping to above
...
3. Quadrant breakdown: PORT In, SAFE, RACE, MAP, PORT Out, OPINION as % of classified
4. SAFE:RACE ratio with four-band RAG applied
5. Top 3 most-used Polaris behaviours (excluding OPINION and UNCLASSIFIED)
...

{
  ...
  "portIn": {
    "purpose":          { "score": 0.0, "evidence": "<1 sentence, max 30 words>" },
    "outcomes":         { "score": 0.0, "evidence": "<1 sentence, max 30 words>" },
    "responsibilities": { "score": 0.0, "evidence": "<1 sentence, max 30 words>" },
    "timedAgenda":      { "score": 0.0, "evidence": "<1 sentence, max 30 words>" }
  },
  "safe": {
    "share":      { "score": 0.0, "evidence": "<1 sentence, max 30 words>" },
    "ask":        { "score": 0.0, "evidence": "<1 sentence, max 30 words>" },
    "facilitate": { "score": 0.0, "evidence": "<1 sentence, max 30 words>" },
    "energise":   { "score": 0.0, "evidence": "<1 sentence, max 30 words>" }
  },
  "race": {
    "resolve":   { "score": 0.0, "evidence": "<1 sentence, max 30 words>" },
    "actioning": { "score": 0.0, "evidence": "<1 sentence, max 30 words>" },
    "challenge": { "score": 0.0, "evidence": "<1 sentence, max 30 words>" },
    "economise": { "score": 0.0, "evidence": "<1 sentence, max 30 words>" }
  },
  "portOut": {
    "plan":             { "score": 0.0, "evidence": "<1 sentence, max 30 words>" },
    "outcomes":         { "score": 0.0, "evidence": "<1 sentence, max 30 words>" },
    "responsibilities": { "score": 0.0, "evidence": "<1 sentence, max 30 words>" },
    "time":             { "score": 0.0, "evidence": "<1 sentence, max 30 words>" }
  },
  ...
  "behaviourDistribution": {
    ...
    "quadrantBreakdown": [
      ...
      { "quadrant": "MAP",      "exchangeCount": 0, "percentOfClassified": 0 },
      { "quadrant": "PORT Out", "exchangeCount": 0, "percentOfClassified": 0 },
      { "quadrant": "OPINION",  "exchangeCount": 0, "percentOfClassified": 0 }
    ],
    "topThreeBehaviours": [
    ...
    "timeEffectivenessSummary": "<2-3 sentences on what the distribution reveals about time use, in Polaris language>"
  }
}`;
}
