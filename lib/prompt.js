...
## EVIDENCE
For each behaviour write ONE concise sentence only — maximum 30 words. Cite a specific moment or phrase from the transcript and state the key gap for scores below 3.5. No preamble.

Use Polaris vocabulary where natural: psychological safety, vulnerability, ${extraVocab}.
