...
## EVIDENCE QUALITY
For each behaviour, your evidence field must do three things — concisely, in 2–3 sentences:
1. **Cite specifically** — reference what was actually said or done, not a general impression
2. **Quantify where possible** — note how many instances of positive or negative indicators you observed
3. **Contextualise the gap** — for any score below 3.5, state briefly what was missing compared to exemplary performance

Evidence should read as analytical commentary, not description. Instead of: "George asked several questions." Write: "Two genuine open questions were observed ('how would that work?' and 'where's the win for you?') — however several closed questions reduced overall quality and no questions probed beneath stated positions to understand underlying interests."
...
Evidence strings are 2–3 sentences: cite specifically, quantify where possible, and state what was missing for any score below 3.5.
