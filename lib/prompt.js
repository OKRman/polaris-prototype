...
For each behaviour, provide one sentence (maximum 30 words) defining what good looks like for that behaviour in this type of meeting. Do not quote from the transcript. Do not reference specific individuals or exchanges. Write in plain English as a definition, not as commentary on this meeting.
...
Analyse the transcript at the level of individual exchanges (one turn of speech by one participant).

Classify each exchange as:
- PORT_IN_purpose | PORT In | "State Purpose"
- PORT_IN_timings | PORT In | "Set Timings"
- SAFE_share | SAFE | "Share": genuine vulnerability or emotional honesty only
- SAFE_ask | SAFE | "Ask": open, curious questions
- SAFE_facilitate | SAFE | "Facilitate": bringing others in or creating space
- SAFE_energise | SAFE | "Energise": positive energy, appreciation, encouragement
- RACE_resolve | RACE | "Resolve": standing firm despite pressure
- RACE_advocate | RACE | "Advocate": proposing a specific solution or action
- RACE_challenge | RACE | "Challenge": constructively challenging an assumption or view
- RACE_economise | RACE | "Economise": redirecting drift or closing completed discussion
- PORT_OUT_decisions | PORT Out | "Confirm Decisions"
- PORT_OUT_responsibilities | PORT Out | "Assign Responsibilities"
- PORT_OUT_timings | PORT Out | "Set Next Steps & Timings"
- WHITE_NOISE | General | "White Noise": any statement or contribution that doesn't map to any of the 16 Polaris behaviours
- UNCLASSIFIED: purely procedural ('Thanks', 'Sorry I'm late', 'Can everyone hear me?')

Calculate:
1. Total exchanges (all turns of speech)
2. Exchanges per behaviour (count and % of non-UNCLASSIFIED)
3. Quadrant breakdown: PORT In, SAFE, RACE, PORT Out, WHITE_NOISE as % of classified
4. SAFE:RACE ratio with four-band RAG applied
5. Top 3 most-used Polaris behaviours (excluding WHITE_NOISE and UNCLASSIFIED)
6. Absent behaviours with 0 instances that would be expected for this meeting type

Where a single exchange demonstrates multiple behaviours, classify by the PRIMARY behaviour.
...

{
  ...
  "portIn": {
    "purpose":          { "score": 0.0, "goodPractice": "<one sentence defining what good looks like for this behaviour>" },
    "outcomes":         { "score": 0.0, "goodPractice": "<one sentence defining what good looks like for this behaviour>" },
    "responsibilities": { "score": 0.0, "goodPractice": "<one sentence defining what good looks like for this behaviour>" },
    "timedAgenda":      { "score": 0.0, "goodPractice": "<one sentence defining what good looks like for this behaviour>" }
  },
  "safe": {
    "share":      { "score": 0.0, "goodPractice": "<one sentence defining what good looks like for this behaviour>" },
    "ask":        { "score": 0.0, "goodPractice": "<one sentence defining what good looks like for this behaviour>" },
    "facilitate": { "score": 0.0, "goodPractice": "<one sentence defining what good looks like for this behaviour>" },
    "energise":   { "score": 0.0, "goodPractice": "<one sentence defining what good looks like for this behaviour>" }
  },
  "race": {
    "resolve":   { "score": 0.0, "goodPractice": "<one sentence defining what good looks like for this behaviour>" },
    "actioning": { "score": 0.0, "goodPractice": "<one sentence defining what good looks like for this behaviour>" },
    "challenge": { "score": 0.0, "goodPractice": "<one sentence defining what good looks like for this behaviour>" },
    "economise": { "score": 0.0, "goodPractice": "<one sentence defining what good looks like for this behaviour>" }
  },
  "portOut": {
    "plan":             { "score": 0.0, "goodPractice": "<one sentence defining what good looks like for this behaviour>" },
    "outcomes":         { "score": 0.0, "goodPractice": "<one sentence defining what good looks like for this behaviour>" },
    "responsibilities": { "score": 0.0, "goodPractice": "<one sentence defining what good looks like for this behaviour>" },
    "time":             { "score": 0.0, "goodPractice": "<one sentence defining what good looks like for this behaviour>" }
  },
  ...
  "behaviourDistribution": {
    ...
    "topThreeBehaviours": [
      { "behaviourId": "", "behaviourName": "", "quadrant": "", "exchangeCount": 0, "percent": 0 },
      { "behaviourId": "", "behaviourName": "", "quadrant": "", "exchangeCount": 0, "percent": 0 },
      { "behaviourId": "", "behaviourName": "", "quadrant": "", "exchangeCount": 0, "percent": 0 }
    ],
    "absentBehaviours": [
      { "behaviourId": "", "behaviourName": "", "quadrant": "", "significance": "" }
    ],
    "crossBehaviouralPatterns": [
      "<named pattern if detected, with brief explanation grounded in scores>"
    ],
    "timeEffectivenessSummary": "<2-3 sentences on what the distribution reveals about how contributions were spread, in Polaris language>"
  }
}`;
}
